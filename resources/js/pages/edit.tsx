...
function EditScheduleForm({ schedule }: { schedule: any }) {
    const [formData, setFormData] = useState<FormData>({
        teacher: schedule?.teacher ? { value: schedule.teacher.id, label: schedule.teacher.name } : null,
        school_classes:
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await axios.patch(`/schedule/${schedule.id}`, payload);

            console.log('Success:', response.data);
            toast.success('✏️ Schedule updated successfully!');
        ...
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50">
            <div className="w-full max-w-3xl">
                <div className="mb-10 text-center">
                    <h1 className="mb-2 text-3xl font-bold text-gray-800">Edit Class Schedule</h1>
